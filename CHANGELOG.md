...
- 実質増加率の表示名を簡潔な「累積実質増加率」に変更

## [0.5.8] - 2026-08-31

### 変更

- 実質増加率の表示名を「実質資産増加率（累計）」に変更し、対象が資産の累積値であることを明確化

## [0.5.7] - 2026-08-31

### 変更

- 実質増加率の表示名を簡潔な「実質増加率」に変更

## [0.5.6] - 2026-08-31

### 変更

- 年齢ごとの実質増加率の表示を「初期資産比の実質増加率（累計）」に変更し、年率の実質利回りとの違いを明確化

## [0.5.5] - 2026-08-31

### 修正

- 詳細データテーブルで条件変更時にページ番号がリセットされず、表が空になる問題を修正

## [0.5.4] - 2026-08-31

### 変更

- テーマ切り替えボタンからダーク／ライトモードの文字ラベルを削除
